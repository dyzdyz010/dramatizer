defmodule DramatizerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DramatizerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DramatizerWeb.Gettext, "errors", msg, opts)
    end
  end
